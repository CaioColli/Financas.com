const formularioDespesa = document.querySelector('#card_addDespesa');
const titulo = formularioDespesa.querySelector('#input_titulo');
const valor = formularioDespesa.querySelector('#input_valor');
const data = formularioDespesa.querySelector('#input_data');
export function verificaDespesa() {
    const btnSubFormulario = document.querySelector('#btn_enviar_formulario_despesa');
