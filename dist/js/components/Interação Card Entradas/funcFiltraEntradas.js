...
// const btnfiltraData = document.querySelector("#filtro_data_entradas") as HTMLButtonElement
// const dadosSalvos: { titulo: string, opcao: string, data: Date, valor: number }[] = []
...
//         const iconeSeta = document.querySelector('#icone_data_entradas') as HTMLElement
//         const elementoPai = document.querySelector('.dados_entradas') as HTMLDivElement
//         if (!clicado) {
